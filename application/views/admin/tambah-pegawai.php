      ...
      <div class="row" id="formAdd">
        <div class="col-md-5">
          <div class="mb-3 row form-group">
            ...
            <div class="col-sm-9">
              <input type="text" class="form-control" name="nama" id="inputNama" required="" value="<?= set_value('nama') ?>">
          ...
          <div class="mb-3 row form-group">
            ...
            <div class="col-sm-9">
              <input type="email" class="form-control" name="email" id="inputEmail" required="" value="<?= set_value('email') ?>">
